			...
			<div class = "col-6 mi_col">
                ...
                <form name="" method="post" action="scripts/crear_avance.php"> 
                    ...
                    <!--<tr>
                        ...
                        <tr>
                            ...
                            <td>    
                                ...
                                <p><em>Si desea que la actividad sea reactivada automaticamente el próximo mes deje abierta, si la actividad no se hará de nuevo marque cerrada.</p></em>
                            </td>
                        </tr>
                    ...
                    <!--<td>Mes:</td>  
                        ...
                        <tr>
                            <td>Desempeño si entrega en este momento:</td>  
