...
<body>
    ...
    <div class = "row justify-content-center mi_row">
        ...
        <div class = "row justify-content-center mi_row">
			<div class = "col-6 mi_col">
				<!-- (row_!Centro!) -->
                <form name="" method="post" action="scripts/reactivar_especial.php"> 
                    ...
                    <!--<tr>
                        ...
                        <tr>
                            ...
                            <td>    
                                ...
                                <p><em>Si desea que la actividad sea reactivada marque abierta, si la actividad no se hará de nuevo marque cerrada.</p></em>
                            </td>
                        </tr>
