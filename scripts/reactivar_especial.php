<?php
	...
	if ($avance_1 == '') 
	{
		...
		header("Location: ../hacer_avance.php");
	}
	else
	{		
        ...
        $query = "UPDATE actividades set avance_1 = '$avance_1', avance_2 = '$avance_2',avance_3 = '$avance_3',avance_4 = '$avance_4',avance_5 = '$avance_5', porcentaje = '$porcentaje', estado = '$estado', informe = '$informe' WHERE codigo_actividad LIKE '$cod_act'";
